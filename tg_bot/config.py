...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "7916888624:AAE0JAaZupAwd_PJZn6zQ97gl5xLiZt-h0g"
    OWNER_ID = "6332937486"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "DN1_H"
